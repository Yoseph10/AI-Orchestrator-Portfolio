#TODO LIST
#HACER QUE LA BUSQUEDA SEA POR SOURCE SI ES QUE ES SOBRE INFO DEL CANDIDADO BUSCARIA EN EL CV
#SI ES INFO SOBRE PROYECTOS DE IA seria buscar por lo de github
#si es alumno, seria mostrar info de cursos - hacer un pdf ficticia con cursos
#agregar a streamlit
#lo de subir el cv a la BD deberia estar fuera de este codigo, en otro script
